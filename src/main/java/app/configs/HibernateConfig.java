...
/**
 * For hibernate use these variables for testing/deployment in .env or config.properties
 * DEPLOYED=true
 * DB_NAME=
 * DB_USERNAME=
 * DB_PASSWORD=
 * CONNECTION_STR=jdbc:postgresql://localhost:5432/
 */
...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        // Add this for each entity: configuration.addAnnotatedClass(Entity.class);
